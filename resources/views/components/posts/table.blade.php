@if (Session::has('success'))
    <div class="flex items-center justify-center mb-4">
        <div id="toast-success"
            class="fixed top-20  left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center w-full max-w-sm p-4 text-gray-700 bg-white rounded-lg shadow-lg border border-green-200 dark:bg-gray-800 dark:text-gray-200 dark:border-green-800 z-50"
            role="alert">
            <div
                class="inline-flex items-center justify-center shrink-0 w-8 h-8 text-green-600 bg-green-100 rounded-lg dark:bg-green-900 dark:text-green-300">
...
<section class=" dark:bg-gray-900 p-3 sm:p-5 antialiased">
    <h2 class="text-xl font-bold text-gray-800 dark:text-white mb-4 pl-4 font-semibold">Posts by :
        {{ Auth::user()->name }}</h2>
            ...
            <div class="flex flex-col md:flex-row items-center space-y-3 md:space-y-0 md:space-x-4 p-4">
                <div class="w-full md:w-1/2">
                    <form method="GET" action="" class="flex items-center">
                        <label for="simple-search" class="sr-only">Search Posts</label>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="post-{{ $post->id }}-dropdown"
                                    ...
                                    <ul class="py-1 text-sm"
                                        ...
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}" type="button"
                                        ...
                                        <li>
                                            <a href="/dashboard/{{ $post->slug }}/edit" type="button"
                                                class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg"
                                                    viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                    <path
                    ...
                    @empty
                        <tr class="border-b dark:border-gray-700">
                            <td colspan="5" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">No posts
                                found.</td>
                        </tr>
                    @endforelse
                </tbody>
